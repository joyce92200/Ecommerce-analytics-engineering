...
**2. Prioritize laptop refund reduction by dollar leak, not rate.** MacBook Air × US has a moderate 12.4% rate but accounts for $365K refunded — more than any other segment. A 2 pp reduction here is worth more than eliminating the worst-rate segment entirely. A 2 pp reduction here would yield an estimated $58K quarterly retained revenue, making it financially more impactful than eliminating several smaller high-rate segments combined.
