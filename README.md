...
| Question | Finding |
|---|---|
| **Revenue by category (QoQ)** | Audio revenue increased by 18%, driven by Q4 promotional activity.<br><br>**High:** Q4 seasonality<br>**High:** Discounting increased conversion/AOV<br>**Medium:** Promotion placement / bundling |
| **Return rate by segment** | Return rates among new customers are 2.3× higher than among repeat customers, indicating higher return propensity in first-time purchases.<br><br>**High:** Expectation mismatch<br>**High:** Low product familiarity<br>**Medium:** Promotion-driven, lower-intent purchases |
| **90-day repeat rate by channel** | Repeat rates differ significantly by acquisition channel: organic search: 31%, paid social: 9%.<br><br>**High:** Intent gap (organic vs discovery)<br>**High:** Broader targeting (lower qualification)<br>**Medium:** Creative / offer misalignment |
| **12-month retention by cohort** | Retention remains low and stable, at approximately ~1% in month 1 across all 48 cohorts (Jan 2019–Dec 2022). Changes in acquisition strategy have not affected repurchase rates, indicating that product mix is the primary driver.<br><br>**High:** Low natural repeat frequency (product lifecycle)<br>**High:** Limited cross-sell opportunities<br>**Medium:** One-off purchase-heavy catalog |
| **Refund rate by product × country** |Laptops show refund rates 2–3× above the company average. The MacBook Air (US) accounts for the largest absolute loss ($365K refunded). The ThinkPad (CA) has a 21.3% refund rate vs. 12.9% in the US, indicating variation in performance across markets.<br><br>**High:** High price → higher return risk<br>**High:** Spec / expectation mismatch<br>**Medium:** Market-specific return behavior<br>**Medium:** Localization (pricing, positioning, support) |
| **Revenue split: website vs. mobile app** | The website accounts for 96.8% of total revenue, while mobile contributes 17% of orders but only 3% of revenue, reflecting a lower average order value (AOV) channel. This share has remained broadly stable (2.95% → 3.93% over 48 months). Improving AOV, rather than increasing order volume, is the primary lever for mobile.<br><br>**High:** Mobile skew to low-AOV purchases<br>**High:** Product mix (accessories-heavy)<br>**Medium:** Mobile UX limits high-value checkout<br>**Low–Medium:** Desktop preference for large purchases |
